...
--
-- Host: 127.0.0.1
-- Creato il: Dic 18, 2024 alle 09:52
...
INSERT INTO `eventi` (`idEvento`, `titolo`, `descrizione`, `prezzo`, `numeroPosti`, `dataEvento`, `oraEvento`, `imglink`) VALUES
...
INSERT INTO `prenotazioni` (`idPrenotazione`, `FKidEvento`, `FKidUtente`, `numeroPrenotati`, `noteEvento`) VALUES
(37, 5, 26, 2, ''),
(38, 7, 26, 1, '');
...
(26, 'mario', 'rossi', 'mario.rossi@gmail.com', '$2b$12$f1jZp8Ou9gGnOJAJv7uPDe9d/033UDcqwzTjJo1gY5jf85pAJOUPm');
...
ALTER TABLE `prenotazioni`
  ...
  ADD KEY `eventiKey` (`FKidEvento`),
  ADD KEY `utentiKey` (`FKidUtente`);
...
--
ALTER TABLE `prenotazioni`
  MODIFY `idPrenotazione` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `prenotazioni`
  ADD CONSTRAINT `eventiKey` FOREIGN KEY (`FKidEvento`) REFERENCES `eventi` (`idEvento`),
  ADD CONSTRAINT `utentiKey` FOREIGN KEY (`FKidUtente`) REFERENCES `utenti` (`idUtente`);
COMMIT;
